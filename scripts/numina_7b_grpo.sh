...
DATA_DIR=/home/ubuntu/o1-replication/CustomTinyZero/data/aime
...
EXPERIMENT_NAME=qwen2.5_7b_aime_from_rl6_step1200
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_DIR/train_aime.parquet \
    data.val_files=$DATA_DIR/test_aime.parquet \
