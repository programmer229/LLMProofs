...
if __name__ == "__main__":
    failure_metrics_file = '/home/ubuntu/o1-replication-usmid/CustomTinyZero/checkpoints/llmjudge_experiments/qwen2.5_7b_ladder_sympyscore_r1/failure_metrics.json'
