...
BASE_MODEL=/home/ubuntu/o1-replication/CustomTinyZero/checkpoints/verl_intergration/llama3.2_3b_integration/actor/global_step_150
...
python3 -m verl.trainer.main_ppo \
    ...
    data.val_files=$DATA_DIR/incorrect_test.parquet \
