...
DATA_DIR=/home/ubuntu/o1-replication/CustomTinyZero/data/arc
...
BASE_MODEL=/home/ubuntu/o1-replication/CustomTinyZero/checkpoints/verl_grpo_arc/deepseek_llm_7b_arc3/actor/global_step_70 # 7B model before collapse in previous run
PROJECT_NAME=verl_grpo_arc
EXPERIMENT_NAME=deepseek_llm_7b_arc2_from_run3_step70
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.ppo_max_token_len_per_gpu=32384 \
