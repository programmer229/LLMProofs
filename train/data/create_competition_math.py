...
if __name__ == '__main__':
    ...
    local_dir = '/home/ubuntu/o1-replication/CustomTinyZero/data/competition_math'

    train_dataset.to_parquet(os.path.join(local_dir, 'train_competition_math.parquet'))
    test_dataset.to_parquet(os.path.join(local_dir, 'test_competition_math.parquet'))
